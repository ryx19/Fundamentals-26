...
var main = function (input) {
  ...
  // if game mode empty
    ...
    if (input == "normal" || input == "reverse") {
      ...
      myOutputValue = `You have selected the game mode ${currentGameMode}`;
  ...
  // Input validation "scissors", "paper", or "stone"
...
var main = function (input) {
  ...
  var drawCondition = input == randomChoice;
  var gameResult = "";
  var messageOutput = `${gameResult}! You selected ${input}, the computer selected ${randomChoice}. <br> Number of wins: ${winNum} <br> Number of loses: ${loseNum} <br> Number of draws: ${drawNum} <br> Number of guesses: ${totalNum} <br> ${userName}'s Win percentage: ${winRate}%`;
